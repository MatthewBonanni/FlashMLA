...
template <int PAGE_BLOCK_SIZE, int HEAD_DIM, typename SmemLayoutK>
struct SmemTransposeFP8_64x64 {
    static_assert((PAGE_BLOCK_SIZE % 64 == 0) && (HEAD_DIM % 64 == 0));
    ...
    using SmemLayoutV =
        decltype(tile_to_shape(SmemLayoutAtomV{},
                 Shape<Int<PAGE_BLOCK_SIZE>, Int<HEAD_DIM>>{}));
    ...
    using SmemLayoutVT = 
        decltype(tile_to_shape(SmemLayoutAtomVT{},
                 Shape<Int<HEAD_DIM>, Int<PAGE_BLOCK_SIZE>>{}));
